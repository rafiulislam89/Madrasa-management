...
const translations = {
    en: {
        ...
        //-----Contacts-----//
        foodTitle:"Food Facilities",
        contactSubtitle1:"Home",
        contactSubtitle2:"Food-List",
    ...
    bn: {
        ...
        foodTitle:"খাদ্য সুবিধা",
        contactSubtitle1:"হোম",
        contactSubtitle2:" খাদ্য তালিকা",
...
function loadLanguage() {
    ...
    document.querySelectorAll('.foodTitle').forEach(el => el.textContent = data.foodTitle);
